import { BusinessType, BusinessCategory, ShopDisplayMode, ServiceType, ServiceCategory, createServiceDefinition, createMerchant } from "./merchant-model.mjs";
...
const LEGACY_SHOP_TYPE_MAP = {
  general: BusinessType.GENERAL_STORE,
  weapons: BusinessType.MASTER_WEAPONSMITH,
  armor: BusinessType.ARMORER,
  magic: BusinessType.WIZARDS_TOWER,
  potions: BusinessType.APOTHECARY,
  scrolls: BusinessType.SCRIBE_SCRIVENER,
  blacksmith: BusinessType.VILLAGE_BLACKSMITH,
  tailor: BusinessType.TAILOR,
  stable: BusinessType.STABLE_LIVERY,
  inn: BusinessType.INN,
  blackMarket: BusinessType.PAWN_SHOP_FENCE,
  jewelry: BusinessType.JEWELER,
  tools: BusinessType.GENERAL_STORE,
  food: BusinessType.GENERAL_STORE,
  custom: BusinessType.CUSTOM
};
